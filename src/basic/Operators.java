...
public class Operators {
    public static void main(String[] args) {
        ...
        num3 = num1 / num2; // 정수와 정수의 나누기 결과는 정수
        System.out.printf("%d / %d = %d\n", num1, num2, num3);

        num3 = num1 % num2;
        System.out.printf("%d %% %d = %d\n", num1, num2, num3);

        num3 = (int)(num1 / r1); // 정수와 실수의 나누기 결과는 실수, (int)는 실수를 정수 형으로 형변환(Type cast) 한다
        System.out.printf("%f\n", num1/r1);
        System.out.printf("%d / %d = %d\n", num1, num2, num3);
        ...
        // L.Value = R.Value : L.Value 는 무조건 변수만 올수 있고, R.Value 는 변수, 값, 수식, 함수가 올수 있다.
        num1 = 2;
        num3 = 0;
        num3 = num3 + num1; // 0+2 ==> num3에 개입
