package cls;
// Class는 로보드 설계도 같은것
// 클래스으 구성 : 데이터 요소 + 행위 요소(기능 요소) ===> 맴버
// 맴버 변수: 필드, Attribute(속성)
// 맴버함수: method(메소드)

//예시
// 로봇 청소기: 움직이기, 바퀴, 흡입기, 걸레, 물통, 흡입, 딱기,

// 접근 제한자: 맴버를 선언할때 반드시 제일 앞에 붙여주어야 한다.
// public: 완전 공개(어디에서도 이 요소에 접근할 수 있다.)
// private: 완전 비공개(해당 클래스 내부 요소에서만 접근할수 있다.)
...
public class Person {
    ...
    // 생성자 규칙: 생성자는 클래스 이름과 동일하게 만들어야 함.
   ...
   public void  introduce(){
    ...
    // 메소드(함수): 클래스의 기능을 정의함
    //  접근제한자 반환형 메소드_이름([매개변수들...]){실행할 명령문들...}
    // 반환형이 void가 아닌 메소드에서는 반드시 return 이라는 키워드를 이용하여 호출한쪽에 결과를 반화환해주야 함.
    //반드시 메소드의 반환형과 return 되는 라료형이 일치해야 함.
    public int getAge(){
        return age;
    }
